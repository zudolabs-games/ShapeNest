...
/// <summary>
/// Phase 51B Editor play-mode verification: in-cell visual footprint and 3D flows.
/// Triggered by Captures/phase51b-autotest.flag or menu Shape Nest / Phase 51B Verify Visual Footprint.
/// </summary>
[InitializeOnLoad]
public static class Phase51BPlayModeVerify
{
    private const string FlagPath = "Captures/phase51b-autotest.flag";
    private const string ReportPath = "Captures/phase51b-report.txt";
    private const string SessionKey = "Phase51B.Verify";
    private const string BeforeReference = "Captures/phase51a-t1-all-shapes.png";
    ...
    static Phase51BPlayModeVerify()
    {
        EditorApplication.playModeStateChanged += OnPlayMode;
        EditorApplication.delayCall += TryBeginFromFlag;
    }

    [MenuItem("Shape Nest/Phase 51B Verify Visual Footprint")]
    ...
    private static void TryBeginFromFlag()
    {
        if (File.Exists(FlagPath))
        {
            ...
            SessionState.SetBool("Phase51A.Verify", false);
            SessionState.SetBool(SessionKey, true);
            if (EditorApplication.isPlaying)
            {
                BeginRun();
    ...
    private static void BeginRun()
    {
        ...
        report.Length = 0;
        lastError = null;
        report.AppendLine("Phase 51B Play Mode verification");
        report.AppendLine(
            "target blockFootprint=" + BoardAdaptivePresentation3D.BlockFootprintRatio.ToString("F2")
            + " nestFootprint=" + BoardAdaptivePresentation3D.NestFootprintRatio.ToString("F2")
            + " tileFaceRatio=" + BoardAdaptivePresentation3D.CellTileFaceRatio.ToString("F2"));
    ...
    private static void Advance()
    {
        switch (step)
        {
            case 0:
                ...
                break;
            case 1:
                Capture("Captures/phase51b-t1-all-shapes.png");
                ...
                break;
            case 2:
                CaptureAngled("Captures/phase51b-t2-angled.png");
                break;
            case 3:
                ...
                break;
            case 4:
                Capture("Captures/phase51b-t3-after-move.png");
                break;
            case 5:
                LoadLevel(Campaign07, "Campaign_07_ChainIntro");
                break;
            case 6:
                Capture("Captures/phase51b-t4-chain.png");
            ...
            case 7:
                ...
                break;
            case 8:
                Capture("Captures/phase51b-t5-nested.png");
            ...
            case 9:
                ...
                break;
            case 10:
                Capture("Captures/phase51b-t9-ice.png");
                InspectIce("T9 ice");
                InspectCentering("T9");
                break;
            case 11:
                ...
                break;
            case 12:
                Capture("Captures/phase51b-t10-shutter.png");
            ...
            case 13:
                ...
                break;
            case 14:
                Capture("Captures/phase51b-t7-magnet-board.png");
                TryMagnetSelect();
                break;
            case 15:
                Capture("Captures/phase51b-t7-magnet-selecting.png");
                CancelMagnet();
                break;
            case 16:
                TryHammerSmash();
                break;
            case 17:
                Capture("Captures/phase51b-t8-hammer.png");
                break;
            default:
