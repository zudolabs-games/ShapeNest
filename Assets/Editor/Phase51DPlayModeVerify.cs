...
/// <summary>
/// Phase 51D Editor play-mode verification: visual-only mesh centering, chain safety.
/// Triggered by Captures/phase51d-autotest.flag or menu Shape Nest / Phase 51D Verify Visual Centering.
/// </summary>
[InitializeOnLoad]
public static class Phase51DPlayModeVerify
{
    private const string FlagPath = "Captures/phase51d-autotest.flag";
    private const string ReportPath = "Captures/phase51d-report.txt";
    private const string SessionKey = "Phase51D.Verify";
    private const string BeforeReference = "Captures/phase51d-t1-all-shapes.png";
    ...
    static Phase51DPlayModeVerify()
    {
        EditorApplication.playModeStateChanged += OnPlayMode;
        EditorApplication.delayCall += TryBeginFromFlag;
    }

    [MenuItem("Shape Nest/Phase 51D Verify Visual Centering")]
    ...
    private static void TryBeginFromFlag()
    {
        if (File.Exists(FlagPath))
        {
            ...
            SessionState.SetBool("Phase51C.Verify", false);
            SessionState.SetBool(SessionKey, true);
            if (EditorApplication.isPlaying)
            {
                BeginRun();
    ...
    private static void BeginRun()
    {
        ...
        report.Length = 0;
        lastError = null;
        report.AppendLine("Phase 51D Play Mode verification");
        report.AppendLine("visual-only visualRoot.localPosition offset; root/grid seating restored from 51B");
    ...
    private static void Advance()
    {
        switch (step)
        {
            case 0:
                ...
                break;
            case 1:
                Capture("Captures/phase51d-t1-all-shapes.png");
                ...
                break;
            case 2:
                CaptureAngled("Captures/phase51d-t2-angled.png");
                break;
            case 3:
                ...
                break;
            case 4:
                Capture("Captures/phase51d-t3-after-move.png");
                break;
            case 5:
                LoadLevel(Campaign07, "Campaign_07_ChainIntro");
                break;
            case 6:
                Capture("Captures/phase51d-t-chain-2.png");
            ...
            case 7:
                ...
                break;
            case 8:
                Capture("Captures/phase51d-t5-nested.png");
            ...
            case 9:
                ...
                break;
            case 10:
                Capture("Captures/phase51d-t9-ice.png");
                InspectIce("T9 ice");
                InspectCentering("T9");
                break;
            case 11:
                ...
                break;
            case 12:
                Capture("Captures/phase51d-t10-shutter.png");
            ...
            case 13:
                ...
                break;
            case 14:
                Capture("Captures/phase51d-t-chain-3.png");
                InspectChainRelativePositions("T chain-3");
                break;
            case 15:
                Capture("Captures/phase51d-t7-magnet-board.png");
                TryMagnetSelect();
                break;
            case 16:
                Capture("Captures/phase51d-t7-magnet-selecting.png");
                CancelMagnet();
                break;
            case 17:
                TryHammerSmash();
                break;
            case 18:
                Capture("Captures/phase51d-t8-hammer.png");
                break;
            default:
    ...
    private static void InspectVisualCenterOffset(string tag)
    {
        ...
        for (int i = 0; i < views.Length; i++)
        {
            ...
            Vector3 expected = BoardAdaptivePresentation3D.ComputeVisualCenterOffsetLocal(
                view.ConfiguredAsNest,
                view.transform);
            ...
            if (meshChild != null && (meshChild.localPosition - expected).magnitude > 0.05f)
            {
                report.AppendLine(
                    "  " + view.ConfiguredShape
                    + (view.ConfiguredAsNest ? " nest" : " block")
                    + " visualLocal=" + meshChild.localPosition.ToString("F4")
