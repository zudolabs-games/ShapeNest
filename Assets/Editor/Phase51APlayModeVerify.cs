...
/// <summary>
/// Phase 51A Editor play-mode verification: mesh/cell centering plus existing 3D flows.
/// Triggered by Captures/phase51a-autotest.flag or menu Shape Nest / Phase 51A Verify Piece Centering.
/// </summary>
[InitializeOnLoad]
public static class Phase51APlayModeVerify
{
    private const string FlagPath = "Captures/phase51a-autotest.flag";
    private const string ReportPath = "Captures/phase51a-report.txt";
    private const string SessionKey = "Phase51A.Verify";
    ...
    static Phase51APlayModeVerify()
    {
        EditorApplication.playModeStateChanged += OnPlayMode;
        EditorApplication.delayCall += TryBeginFromFlag;
    }

    [MenuItem("Shape Nest/Phase 51A Verify Piece Centering")]
    ...
    {
        if (File.Exists("Captures/phase51b-autotest.flag")
    ...
    private static void BeginRun()
    {
        ...
        report.Length = 0;
        lastError = null;
        report.AppendLine("Phase 51A Play Mode verification");
    ...
    private static void Advance()
    {
        switch (step)
        {
            case 0:
                ...
                break;
            case 1:
                Capture("Captures/phase51a-t1-all-shapes.png");
                InspectMeshes("T1 all-shapes");
                InspectCentering("T1");
                InspectFactoryMeshes();
                break;
            case 2:
                CaptureAngled("Captures/phase51a-t2-angled.png");
                break;
            case 3:
                ...
                break;
            case 4:
                Capture("Captures/phase51a-t3-after-move.png");
                break;
            case 5:
                LoadLevel(Campaign07, "Campaign_07_ChainIntro");
                break;
            case 6:
                Capture("Captures/phase51a-t4-chain.png");
            ...
            case 7:
                ...
                break;
            case 8:
                Capture("Captures/phase51a-t5-nested.png");
            ...
            case 9:
                ...
                break;
            case 10:
                Capture("Captures/phase51a-t9-ice.png");
                InspectIce("T9 ice");
                InspectCentering("T9");
                break;
            case 11:
                ...
                break;
            case 12:
                Capture("Captures/phase51a-t10-shutter.png");
            ...
            case 13:
                ...
                break;
            case 14:
                Capture("Captures/phase51a-t7-magnet-board.png");
                TryMagnetSelect();
                break;
            case 15:
                Capture("Captures/phase51a-t7-magnet-selecting.png");
                CancelMagnet();
                break;
            case 16:
                TryHammerSmash();
                break;
            case 17:
                Capture("Captures/phase51a-t8-hammer.png");
                break;
            default:
