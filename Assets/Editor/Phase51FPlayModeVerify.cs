...
/// <summary>
/// Phase 51F Editor play-mode verification: visual-only mesh centering, chain safety.
/// Triggered by Captures/phase51f-autotest.flag or menu Shape Nest / Phase 51F Verify Perceived Centering.
/// </summary>
[InitializeOnLoad]
public static class Phase51FPlayModeVerify
{
    private const string FlagPath = "Captures/phase51f-autotest.flag";
    private const string ReportPath = "Captures/phase51f-report.txt";
    private const string SessionKey = "Phase51F.Verify";
    private const string BeforeReference = "Captures/phase51f-before-t1-all-shapes.png";
    ...
    static Phase51FPlayModeVerify()
    {
        EditorApplication.playModeStateChanged += OnPlayMode;
        EditorApplication.delayCall += TryBeginFromFlag;
    }

    [MenuItem("Shape Nest/Phase 51F Verify Perceived Centering")]
    ...
    private static void TryBeginFromFlag()
    {
        if (File.Exists(FlagPath))
        {
            ...
            SessionState.SetBool("Phase51E.Verify", false);
            SessionState.SetBool(SessionKey, true);
            if (EditorApplication.isPlaying)
            {
                BeginRun();
    ...
    private static void BeginRun()
    {
        ...
        report.Length = 0;
        lastError = null;
        report.AppendLine("Phase 51F Play Mode verification");
        report.AppendLine(
            "board-plane offset local="
    ...
    private static void Advance()
    {
        switch (step)
        {
            case 0:
                ...
                break;
            case 1:
                Capture("Captures/phase51f-t1-all-shapes.png");
                ...
                break;
            case 2:
                CaptureAngled("Captures/phase51f-t2-angled.png");
                break;
            case 3:
                ...
                break;
            case 4:
                Capture("Captures/phase51f-t3-after-move.png");
                break;
            case 5:
                LoadLevel(Campaign07, "Campaign_07_ChainIntro");
                break;
            case 6:
                Capture("Captures/phase51f-t-chain-2.png");
            ...
            case 7:
                ...
                break;
            case 8:
                Capture("Captures/phase51f-t5-nested.png");
            ...
            case 9:
                ...
                break;
            case 10:
                Capture("Captures/phase51f-t9-ice.png");
                InspectIce("T9 ice");
                InspectCentering("T9");
                break;
            case 11:
                ...
                break;
            case 12:
                Capture("Captures/phase51f-t10-shutter.png");
            ...
            case 13:
                ...
                break;
            case 14:
                Capture("Captures/phase51f-t-chain-3.png");
                InspectChainRelativePositions("T chain-3");
                break;
            case 15:
                Capture("Captures/phase51f-t7-magnet-board.png");
                TryMagnetSelect();
                break;
            case 16:
                Capture("Captures/phase51f-t7-magnet-selecting.png");
                CancelMagnet();
                break;
            case 17:
                TryHammerSmash();
                break;
            case 18:
                Capture("Captures/phase51f-t8-hammer.png");
                break;
            default:
